...
public class ManageNetworkJPanel extends javax.swing.JPanel {
    ...
    private void populateNetworkTable() {
         networkJTable.getTableHeader().setFont(new Font("Segoe UI", 1, 20));
    ...
    private void initComponents() {
        ...
        kGradientPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 392, 70, 40));
        ...
        kGradientPanel1.add(nameJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 390, 190, 40));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel7.setText("Manage Network");
        kGradientPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 80, 380, 50));

        editNetworkjButton.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
